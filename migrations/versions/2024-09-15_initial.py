...
Revision ID: 8167b372fb0d
Revises: 
Create Date: 2024-09-15 04:53:48.536163
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('Asia/Shanghai', now())"), nullable=False),
